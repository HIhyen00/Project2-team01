            ...
            <div className="bg-blue-50">
                <div className="max-w-4xl mx-auto px-4 py-8 grid grid-cols-2 gap-30 ">
                    <div className="flex flex-col items-start justify-center space-y-4">
                        ...
                        <button
                            className="w-50 h-12 bg-blue-400 flex items-center justify-center text-base font-bold border text-white rounded-lg"
                        >
                            서비스 소개서 다운로드
                        </button>
                    </div>
                    <div className="content-center">
                        <div className="w-90 h-80 bg-blue-500 rounded flex items-center justify-center cent">
